...
<div class="top-bar con row">
    <nav class="menu-box-1">
      <ul class="row">
          <li class="cell"><a href="#" class="block">전체 클래스 목록보기</a></li>
          <li class="cell"><a href="#" class="block">클래스 개설하기</a></li>
      ...
      <div class="row">
       <c:forEach items="${rblist}" var="dto" varStatus="status">
        ...
        <div class="thumbnail" style="width: 250px; height: 350px; ">
          <img class="img-circle" src="/classimages/${dto.tfile }" alt="Class Image" width="150" height="200">
          <h4>${dto.title}</h4>
          <p>  
          <c:if test="${dto.payment eq 'charge' }">
          &nbsp;유료 [<img src="/images/won.png" height="14px">${dto.price }]
          </c:if>
