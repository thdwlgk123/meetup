...
<div class="container-fluid">
	<div class="row">
      ...
      <h1 class="page-header">${user }님이 개설한 클래스 문의 채팅목록</h1>         
  ...
  firebase.database().ref().child('chatmanager').child(chatroomname).on('child_added', snap => {
	  console.log(snap.val());
		  ...
		  li.innerHTML =content;
		   --%>
		  li.innerHTML ="<div class=\"row\"><div class=\"col-lg-12\"><div class=\"media\"><div class=\"media-body\"><h4 class=\"media-heading\"><a href=\"/chat/managerclasschat?classid="+<%=classid%>+"&memid="+snap.val().userId+"\">message from   :   '"+snap.val().userId+"'</a><span class=\"small pull-right\"></span></h4><p>"+snap.val().message+"<span>&nbsp;&nbsp;"+year+"."+month+"."+day+" "+hour+":"+minute+"</span></p></div></div></div></div>";
