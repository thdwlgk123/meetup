...
<div id="main_content">	
	...
	<table class="table" style="align:center">
		<tr>
		<th scope="row">아이디</th>
		<td> <input type="text" onkeyup="idCheckFunciton();" id="userID" name="userID" size="20" ></td>
		<td style="width: 110px;">
			<button onclick="registerCheckFunction();" type="button" id="idcheckbtn" value="false">중복체크</button>
		</td>
		<div class="text_wrapper" style="display:none;"><input type="text" id="idvalue" value="" /></div>
		</tr>
		<tr ><th></th><td style="text-align: left;color: red; font-size: 0.8em" colspan="3" id="checkMessage"></td></tr>
		<tr>
		...
		<tr>
		<th scope="row">메일 : </th><td><input type="text" id="usereMail" name="usereMail" size="20"></td>
		</tr>
