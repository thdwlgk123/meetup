...
//		  li.innerHTML ="<div class=\"row\"><div class=\"col-lg-12\"><div class=\"media\"><a class=\"pull-left\" href=\"#\"><img class=\"media-object img-circle img-chat\" src=\"/images/"+${profileimage}+"\" alt=\"\"></a><div class=\"media-body\"><h4 class=\"media-heading\">"+snap.val().userId+"<span class=\"small pull-right\"></span></h4><p>"+snap.val().message+"<span>&nbsp;&nbsp;"+year+"."+month+"."+day+" "+hour+":"+minute+"</span></p></div></div></div></div>";
		  // 삭제, 수정시 변동사항 체크를 위하여
				if(chatId==manId){
					li.innerHTML ="<div class=\"row\"><div class=\"col-lg-12\"><div class=\"media\"><a class=\"pull-right\" href=\"#\"><img class=\"media-object img-circle img-chat\" src=\"/images/${manprofimage}\" alt=\"\"></a><div class=\"pull-right\"><h4 class=\"media-heading\">"+snap.val().userId+"<span class=\"small pull-left\"></span></h4><p>"+snap.val().message+"<span>&nbsp;&nbsp;"+year+"."+month+"."+day+" "+hour+":"+minute+"</span></p></div></div></div></div>";				  
				}else{
